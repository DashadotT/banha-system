  ...
  return (
    ...
    >
      <p className="text-sm text-slate-600">
        Archive <span className="font-medium text-primary">{itemLabel}</span>? Archived data is
        removed from active views and excluded from Dashboard totals, generated reports,
        Pearson correlation, and t-test calculations. You can restore it later from Archived
        Records.
      </p>
    </Modal>
  );
